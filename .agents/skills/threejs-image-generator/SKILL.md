...
Resolve `<this-skill-dir>` in the commands below in this order: `~/.Codex/skills/threejs-image-generator`, `~/.codex/skills/threejs-image-generator`, `~/.agents/skills/threejs-image-generator`, or repo `skills/threejs-image-generator`.

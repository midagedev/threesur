...
Resolve `<this-skill-dir>` in the commands below in this order: `~/.Codex/skills/threejs-audio-generator`, `~/.codex/skills/threejs-audio-generator`, `~/.agents/skills/threejs-audio-generator`, or repo `skills/threejs-audio-generator`.
